...
class FileSender < ApplicationRecord
  ...
  after_save :mail_delete_alert, if: Proc.new{|file_sender| !file_sender.is_expired && !file_sender._delete_mail_sent && !file_sender.receiver_delete_mail_sent && file_sender.receiver_mail_sent && file_sender.sender_mail_sent}
